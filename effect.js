...
// 		$( "#card" ).removeClass( "dispNoe" );
		$('body').addClass('card_body');
		$('body').removeClass('peach-after');
		$('body').removeClass('peach');
			$('#surprise').fadeIn('slow');
	});
	$('#surprise').click(function(){
		$( "#card" ).addClass( "dispNoe" );
		$('body').removeClass('card_body');
		$('body').addClass('card_body');
		$( "#finl_h1" ).css( "display","block" );
		$( "#finl_h2" ).css( "display","block" );
		$("#finl_h2").css("top", "35%")
		$( "#birthday" ).css( "display","block" );	

		 var audio = $("#player"); 
		   audio[0].pause();
    $("#sound").attr("src", "cr.mp3");
		    audio[0].load();
		audio[0].play();
		loop()
		var i;
		...
		function msgLoop (i) {			
			...
			$("span:nth-child("+i+")").fadeIn('slow').delay(1000).promise().done(function(){
				i=i+1;
			if(i==10){
